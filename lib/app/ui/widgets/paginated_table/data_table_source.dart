...
/// A data source for obtaining row data for [PaginatedDataTableCustom] objects.
///
...
/// each build.
abstract class DataTableSourceCustom extends ChangeNotifier {
  /// Called to obtain the data about a particular row.
  ///
  /// The [DataRowCustom.byIndex] constructor provides a convenient way to construct
  /// [DataRowCustom] objects for this callback's purposes without having to worry about
  ...
  /// and [getRows] must return a non-null value for all indices in the range 0
